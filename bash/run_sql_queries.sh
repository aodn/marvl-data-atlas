...
# create and populate the marvl3 views and add indexes
SQL_FILES="$SQL_FILES ../sql_queries/Create_MarvlRawDataView.sql"
SQL_FILES="$SQL_FILES ../sql_queries/Create_MarvlAtlasDataView.sql"
