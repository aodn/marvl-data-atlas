...
INSERT INTO source (SELECT 'IMOS/AODN', 'ANFOG', '', 'DM', 'trajectory','anfog_dm','anfog_dm_trajectory_data','file_id','1-min average');
...
INSERT INTO source (SELECT 'IMOS/AODN', 'AODN', '', 'DSTO', 'trajectory','aodn_dsto','aodn_dsto_trajectory_data','file_id','1-min average');
...
INSERT INTO source (SELECT 'IMOS/AODN', 'AUV', '', '', 'trajectory','auv','auv_trajectory_st_data','file_id','1-min average');
...
INSERT INTO source (SELECT 'IMOS/AODN', 'SOOP', 'TRV', '', 'trajectory','soop_trv','soop_trv_trajectory_data','trip_id','1-min average');
...
INSERT INTO source (SELECT 'IMOS/AODN', 'SOOP', 'TMV', 'DM', 'trajectory','soop_tmv','soop_tmv_trajectory_data','file_id','1-min average');
...
INSERT INTO source (SELECT 'CSIRO', '', 'Trajectory', '', 'trajectory','aodn_csiro_cmar','aodn_csiro_cmar_trajectory_data','"SURVEY_ID"','1-min average');
INSERT INTO source (SELECT 'CSIRO', '', 'Underway', '', 'trajectory','aodn_csiro_cmar','aodn_csiro_cmar_underway_data','"SURVEY_ID"','1-min average');
