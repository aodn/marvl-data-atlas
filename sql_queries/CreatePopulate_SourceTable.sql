...
INSERT INTO source (SELECT 'IMOS/AODN', 'SRS', 'Altimetry', '', 'timeSeries','srs_altimetry','measurements','file_id');
...
INSERT INTO source (SELECT 'CSIRO', '', 'Mooring', '', 'timeSeries','aodn_csiro_cmar','aodn_csiro_cmar_mooring_data','"SURVEY_ID+SERIAL_NO"');
