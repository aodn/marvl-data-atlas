...
SELECT
(width_bucket(s."LONGITUDE", 110.875, 155.125, 176)-1)*0.25+111 AS "LONGITUDE", -- we consider LONGITUDE buckets of size 0.25 with first value centred on 111 : [110.875;111.125[, [111.125;111.375[, [111.375;111.625[, [111.625;111.875[, etc...
(width_bucket(s."LONGITUDE", 110.875, 155.125, 176)-1)*0.25+110.875 AS "LONGITUDE_bound_min",
(width_bucket(s."LONGITUDE", 110.875, 155.125, 176)-1)*0.25+111.125 AS "LONGITUDE_bound_max",
